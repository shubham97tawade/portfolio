    ...
    return(
        <section className="grid grid-rows-2 md:grid-cols-2 w-5/6 md:w-2/3 bg-white rounded overflow-hidden h-[32rem] md:h-80">
            ...
            <article className="grid-row p-6 md:p-8">
                <h1 className="line-clamp-1 md:line-clamp-1 overflow-hidden text-ellipsis text-lg text-2xl font-bold mb-4">{blog?.blog_title}</h1>
                <div className="line-clamp-4 md:line-clamp-6 overflow-hidden text-ellipsis text-gray-900" dangerouslySetInnerHTML={{__html : blog?.blog_para}}></div>
